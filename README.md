...
Este projeto � independente do IDE (Eclipse, Netbeans, etc.), por�m usa Maven. 
Se preferir n�o usar Maven, veja as vers�es de cada depend�ncia externa no arquivo pom.xml.
