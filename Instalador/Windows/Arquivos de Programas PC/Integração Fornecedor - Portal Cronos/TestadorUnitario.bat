...
if exist C:/"Program Files (x86)"/Java/jre1.8.0_161/bin/java.exe (
    C:/"Program Files (x86)"/Java/jre1.8.0_161/bin/java.exe -cp integr-fornecedor-2.8.2.jar pcronos.integracao.fornecedor.TestadorSnippets >> TestadorUnitario.log
) else if exist C:/"Program Files (x86)"/Java/jre1.8.0_111/bin/java.exe (
    C:/"Program Files (x86)"/Java/jre1.8.0_111/bin/java.exe -cp integr-fornecedor-2.8.2.jar pcronos.integracao.fornecedor.TestadorSnippets >> TestadorUnitario.log
) else if exist C:/"Program Files"/Java/jre1.8.0_92/bin/java.exe (
    C:/"Program Files"/Java/jre1.8.0_92/bin/java.exe -cp integr-fornecedor-2.8.2.jar pcronos.integracao.fornecedor.TestadorSnippets >> TestadorUnitario.log
) else (
    echo MSGBOX "Erro! O JRE não foi encontrado!" > %temp%\TEMPmessage.vbs
    exit
)
