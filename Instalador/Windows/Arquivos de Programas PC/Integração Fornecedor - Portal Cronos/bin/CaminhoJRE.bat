...
if exist C:/"Program Files (x86)"/Java/jre1.8.0_111/bin/java.exe (
    goto PathPadeirao
) else if exist C:/"Program Files"/Java/jre1.8.0_161/bin/java.exe (
    goto PathFormaggio
    ...
    goto PathProlac
) else if exist C:/"Program Files"/Java/jre1.8.0_261/bin/java.exe (
    goto PathPropao
) else if exist C:/"Program Files"/Java/jre1.8.0_271/bin/java.exe (
    goto PathInga
...
:PathFormaggio
set path=C:\Program Files\Java\jre1.8.0_161\bin;%path%
C:/"Program Files"/Java/jre1.8.0_161/bin/java.exe -cp integr-fornecedor-%versaoIntegrador%.jar pcronos.integracao.fornecedor.%2 %3 %4 >> %1
goto PularPathOutros
...
REM Errado em versões < 2.1.2B: set path=%path%;C:\Program Files\Java\jre1.8.0_261\bin
C:/"Program Files"/Java/jre1.8.0_261/bin/java.exe -cp integr-fornecedor-%versaoIntegrador%.jar pcronos.integracao.fornecedor.%2 %3 %4 >> %1
goto PularPathOutros

:PathInga
set path=C:\Program Files\Java\jre1.8.0_271\bin;%path%
REM Errado em versões < 2.1.2B: set path=%path%;C:\Program Files\Java\jre1.8.0_271\bin
C:/"Program Files"/Java/jre1.8.0_271/bin/java.exe -cp integr-fornecedor-%versaoIntegrador%.jar pcronos.integracao.fornecedor.%2 %3 %4 >> %1
goto PularPathOutros
