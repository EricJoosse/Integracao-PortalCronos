...
REM C:/"Program Files"/Java/jre1.8.0_92/bin/java.exe -cp integr-fornecedor-2.3.2.jar pcronos.integracao.fornecedor.TestadorSnippets >> Job15a15minOfertamentoJava.log
C:/"Program Files"/Java/jre1.8.0_92/bin/java.exe -cp integr-fornecedor-2.3.2.jar pcronos.integracao.fornecedor.IntegracaoFornecedorCompleta >> Job15a15minOfertamentoJava.log
REM Prolac: C:/"Program Files (x86)"/Java/jre1.8.0_161/bin/java.exe -cp integr-fornecedor-2.3.2.jar pcronos.integracao.fornecedor.IntegracaoFornecedorCompleta >> Job15a15minOfertamentoJava.log
