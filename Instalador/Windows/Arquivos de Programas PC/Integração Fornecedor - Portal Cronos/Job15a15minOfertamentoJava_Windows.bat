...
REM C:/"Program Files"/Java/jre1.8.0_92/bin/java.exe -cp integr-fornecedor-2.0.0.jar pcronos.integracao.fornecedor.TestesComponentes >> Job15a15minOfertamentoJava.log
C:/"Program Files"/Java/jre1.8.0_92/bin/java.exe -cp integr-fornecedor-2.0.0.jar pcronos.integracao.fornecedor.IntegracaoFornecedorCompleta >> Job15a15minOfertamentoJava.log
