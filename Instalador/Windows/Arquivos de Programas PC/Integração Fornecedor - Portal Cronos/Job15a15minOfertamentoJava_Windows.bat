...
REM C:/"Program Files"/Java/jre1.8.0_92/bin/java.exe -cp integr-fornecedor-2.3.1.jar pcronos.integracao.fornecedor.TestadorSnippets >> Job15a15minOfertamentoJava.log
