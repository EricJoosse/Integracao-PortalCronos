...
create table [dbo].[Configuracao_Monitorador_Integradores](
	...
	funcao_contato_ti_conmonint varchar(30) NOT NULL,

	apelido_contato_ti_secundario_conmonint varchar(15) NOT NULL,
	email_contato_ti_secundario_conmonint varchar(30) NOT NULL,
	skype_contato_ti_secundario_conmonint  varchar(30) NOT NULL,
	funcao_contato_ti_secundario_conmonint varchar(30) NOT NULL,
